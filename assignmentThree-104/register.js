...
function registerPet(){
   ...
   //console.log(inputName,inputAge,inputGender,inputBreed,inputService,inputOwnerName,inputOwnerPhone)
    ...
    if(validation(inputName,inputAge,inputGender,inputBreed,inputService,inputOwnerName,inputOwnerPhone)){
        var thePet=new Pet(inputName,Number(inputAge),inputGender,inputBreed,inputService,inputOwnerName,inputOwnerPhone);
    ...
    setTimeout(function(){
        ...
        var fail=document.getElementById('danger')
